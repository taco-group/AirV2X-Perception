...
def parse_timestamp_agent(agent_path: str) -> Dict[str, Any]:
    ...
    eg. dataset/skylink/2025_04_09_22_34_07/timestamp_000000/agent_001514
...
def parse_timestamp(path: str) -> Dict[Union[str, int], Any]:
    ...
    eg. dataset/skylink/2025_04_09_22_34_07/timestamp_000000/<agent_idx>/
...
def parse_seq(path: str, opv2vformat: bool = True) -> Dict[int, Any]:
    ...
    eg. /code/dataset/skylink/2025_04_09_22_34_07/<timestamp>/<agent>

    Args:
        path (str): path ot sequence
        opv2vformat (bool): convert to opv2v format seq/agent/timestamp, skylink is seq/timestamp/agent
...
def project_lidar_to_cam_single(
    ...
    # lidar2world = x_to_world(lidar_abs_pos) # (4, 4)

    # transform lidar points to world space
    # world_points = np.dot(lidar2world, local_lidar_points) # (4, pcd size)

    # project lidar world points to camera space using inv(intrinsic)
    # abs_pos -> (4, 4)
    # cam2world = x_to_world(cam_abs_pos)
...
if __name__ == "__main__":
    # # timestamp = "/code/dataset/skylink/2025_04_09_22_34_07/timestamp_000000"
    # # data = parse_timestamp(timestamp)
    # seq_path = "/code/dataset/skylink/2025_04_09_22_34_07"

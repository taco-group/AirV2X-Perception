...
from opencood.models.where2comm_modules.base_bev_backbone_resnet import (
    ResNetBEVBackbone,
)
...
class PointPillarWhere2comm(nn.Module):
    def __init__(self, args):
        ...
        self.cls_head = nn.Conv2d(
            128 * 2, args["anchor_number"], kernel_size=1
        )  # 分类头, True/False 256 -> 2
        self.reg_head = nn.Conv2d(
            128 * 2, 7 * args["anchor_number"], kernel_size=1
        )  # 回归头, x/y/z/h/w/l/yaw 256, 14

...
from opencood.models.airv2x_bm2cp import Airv2xBase


class Airv2xV2VNet(Airv2xBase):
    ...
    def forward(self, data_dict):
        ...
        cv2.imwrite("/home/xiangbog/Folder/Research/SkyLink/airv2x/debug/debug_image_bevfeat.png", ((feat - feat.min()) / (feat.max() - feat.min()) * 255).astype(np.uint8),)

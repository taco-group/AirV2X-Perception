...
class LiftSplatShootEncoder(nn.Module):
    def __init__(self, args):
        ...
        self.cls_head = nn.Conv2d(
            self.bevout_feature, args["anchor_number"], kernel_size=1
        )
        self.reg_head = nn.Conv2d(
            self.bevout_feature, 7 * args["anchor_number"], kernel_size=1
        )
    ...
    def forward(self, data_dict):
        ...
        output_dict = {"spatial_features": x, "spatial_features_3d": x.unsqueeze(2)}

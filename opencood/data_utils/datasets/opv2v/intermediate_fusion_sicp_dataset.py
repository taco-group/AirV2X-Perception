...
class IntermediateFusionSicpDataset(basedataset.BaseDataset):
    ...
    def __init__(self, params, visualize, train=True):
        super(IntermediateFusionSicpDataset, self).__init__(params, visualize, train)
        ...
        if (
            "use_comm_range_check" in params["fusion"]["args"]
            and not params["fusion"]["args"]["use_comm_range_check"]
        ):
    ...
    def __getitem__(self, idx):
        ...
        object_bbx_center_ego = np.zeros((self.params["postprocess"]["max_num"], 7))
        ...
        label_dict_ego = self.post_processor.generate_label(
            gt_box_center=object_bbx_center_ego, anchors=anchor_box_ego, mask=mask_ego
        )
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose, ego_params):
        ...
        while (
            ...
            and processed_radar["voxel_features"].shape[0] == 0
        ):
    ...
    def collate_batch_train(self, batch):
        ...
        label_torch_dict_ego = self.post_processor.collate_batch(label_dict_ego_list)
    ...
    def get_pairwise_transformation(self, base_data_dict, max_cav):
        ...
        if self.proj_first:
            ...
            warnings.warn(
                "Projection later is not supported in "

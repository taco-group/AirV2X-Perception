...
class IntermediateFusionDatasetSkylinkSiCP(basedataset.BaseDataset):
    """
    ...
    def __init__(self, params, visualize, train=True):
        super(IntermediateFusionDatasetSkylinkSiCP, self).__init__(
    ...
    def __getitem__(self, idx):
        ...
        ego_label_dict = self.post_processor.generate_label_skylink(
    ...
    def collate_batch_train(self, batch):
        ...
        ego_label_dict_torch = self.post_processor.collate_batch_skylink(
            ego_label_dict_list
        )
...
if __name__ == "__main__":
    ...
    skylink_database = IntermediateFusionDatasetSkylinkSiCP(params, None)

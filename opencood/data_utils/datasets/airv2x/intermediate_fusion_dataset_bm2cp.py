...
class IntermediateFusionDatasetAirv2xBM2CP(basedataset.BaseDataset):
    """
    ...
    def __init__(self, params, visualize, train=True):
        super(IntermediateFusionDatasetAirv2xBM2CP, self).__init__(
    ...
    def generate_depth_map(
        ...
        vis_image, points_2d = airv2x_utils.project_lidar_to_cam_single(
...
if __name__ == "__main__":
    ...
    airv2x_database = IntermediateFusionDatasetAirv2xBM2CP(params, None)

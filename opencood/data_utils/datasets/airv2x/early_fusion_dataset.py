...
class EarlyFusionDatasetAirv2x(basedataset.BaseDataset):
    """
    ...
    def __init__(self, params, visualize, train=True):
        super(EarlyFusionDatasetAirv2x, self).__init__(params, visualize, train)
    ...
    def collate_batch_test(self, batch):
        ...
        for cav_id, cav_content in batch.items():
            ...
            # label dictionary
            label_torch_dict = self.post_processor.collate_batch_airv2x(
